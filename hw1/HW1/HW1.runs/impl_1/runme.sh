...
HD_PWD='C:/Users/C27Jayden.Randolph/ece383_wksp/hw1/HW1/HW1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scancode_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scancode_decoder.tcl -notrace
