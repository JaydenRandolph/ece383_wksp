...
HD_PWD='C:/Users/C27Jayden.Randolph/ece383_wksp/Keyboard_Demo/Keyboard_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Keyboard_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Keyboard_Demo.tcl -notrace
