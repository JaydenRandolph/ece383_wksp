...
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS12} [get_ports {switch[3]}]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS12} [get_ports {switch[2]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {control/sw_dbg[0]} {control/sw_dbg[1]} {control/sw_dbg[2]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {control/cw_dbg[0]} {control/cw_dbg[1]} {control/cw_dbg[2]}]]
