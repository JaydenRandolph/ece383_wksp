...
begin
    ...
    delta_x_offset <= (signed_next-signed_base) * signed_offset; -- (Q16.0 - Q16.0) * Q1.8 = Q17.8
    base_plus_delta_x_offset <= (signed_base) + (delta_x_offset(23 downto 8)); -- Q16.0 + [Q17.8 sliced to Q16.0]
