...
begin
    ...
    phase_inc <= x"01A8" when btn(0) = '1' else --top button; Eb
                 x"0217" when btn(1) = '1' else --left button; G
                 x"027C" when btn(2) = '1' else --bottom button; Bb (high)
                 x"00E9" when btn(3) = '1' else --right button; Bb (low)
                 x"0099" when btn(4) = '1' else --center button; my birthday - 0113 (Jan 13)
                 x"0044"; --50Hz; default
