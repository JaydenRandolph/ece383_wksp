...
HD_PWD='C:/Users/C27Jayden.Randolph/ece383_wksp/hw3/hw3/hw3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw3_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw3_tb.tcl
