...
HD_PWD='C:/Users/C27Jayden.Randolph/ece383_wksp/hw2/scancode_decoder/scancode_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scancode_decoder_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scancode_decoder_tb.tcl -notrace
